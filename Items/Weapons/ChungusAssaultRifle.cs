...
{
	public class ChungusAssaultRifle : ModItem
	{
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("R.I.P Egg Bert... yolks to be. shoots green bunnies");
		}
		...
		public override void SetDefaults()
		{
			...
			item.autoReuse = true;
			item.shoot = 10; //this never works omfg
			item.shootSpeed = 6f;
			item.useAmmo = AmmoID.Bullet;
		}
		public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
			Projectile.NewProjectile(position.X, position.Y, speedX, speedY, mod.ProjectileType("ChungusBullet"), damage, knockBack, player.whoAmI, 0f, 0f);
			return false;
		}
