using CringeMod.Items.Weapons;
using CringeMod.Projectiles;
...
{
	public class EggK47 : ModItem
	{
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("will blast u with yolks");
		}
		...
		{
			Projectile.NewProjectile(position.X, position.Y, speedX, speedY, mod.ProjectileType("EggBullet"), damage, knockBack, player.whoAmI, 0f, 0f);
			return false;
		}
